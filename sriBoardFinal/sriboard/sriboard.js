...
function startRecord(){
  if (isRecording==1) {
    document.getElementById("textparagraph").innerHTML="Already Recording";
    ...
    d=new Date();
    n=d.getTime();
    document.getElementById("textparagraph").innerHTML="Started Recording";
    document.getElementById("textparagraph").style.color="red";
  }
}
...
function stopRecord(){
  if (isRecording==1) {
    isRecording=0;
    document.getElementById("textparagraph").innerHTML="Stopped Recording";
    document.getElementById("textparagraph").style.color="black";
  }
  else {
    document.getElementById("textparagraph").innerHTML="Not Recording";
    document.getElementById("textparagraph").style.color="black";
  }
}
...
function playRecord2(){
  ...
  if (recordNotes.length>0) {
    document.getElementById("textparagraph").innerHTML="Playing Recording";
    document.getElementById("textparagraph").style.color="black";
  }
  else {
    document.getElementById("textparagraph").innerHTML="No Recording";
    document.getElementById("textparagraph").style.color="black";
  }
}
...
function playRecord(){
  if (count<recordNotes.length) {
    ...
    document.getElementById("textparagraph").innerHTML="Done Playing";
  }
}

function saveRecord(){
  location.replace("saverecord.php?recordNotes="+recordNotes+"&delayNotes="+delayNotes);
  document.getElementById("textparagraph").innerHTML="Recording Saved";
}

function playSaveRecordFile(){
  location.replace("playsave.php");
  document.getElementById("textparagraph").innerHTML="Loaded";
}
...
function showkeys(){
  var showwhitekeytext=document.getElementsByClassName("whitekey");
  var showblackkeytext=document.getElementsByClassName("blackkey");
  if (showwhitekeytext[0].style.display=="block") {
    for (var i = 0; i < showwhitekeytext.length; i++) {
      showwhitekeytext[i].style.display="none";
    }
    for (var i = 0; i < showblackkeytext.length; i++) {
      showblackkeytext[i].style.display="none";
    }
  }
  else {
    for (var i = 0; i < showwhitekeytext.length; i++) {
      showwhitekeytext[i].style.display="block";
    }
    for (var i = 0; i < showblackkeytext.length; i++) {
      showblackkeytext[i].style.display="block";
    }
  }
}
