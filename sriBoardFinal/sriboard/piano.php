<?php
 ...
 <?php
    if (!isset($_SESSION['email'])){
      header("Location: ../signin/signin.php?error=loggedout&instrument=piano");
    }
?>
<!DOCTYPE html>
  ...
  <head>
    ...
    <script type="text/javascript">
      function normalOctave(){
        location.replace("piano.php?octave=0");
      }
      function lowOctave(){
        location.replace("piano.php?octave=-1");
      }
      function highOctave(){
        location.replace("piano.php?octave=1");
      }
...
<?php
  if ($_GET['octave']==-1) {
    echo '<audio id="C5" src="../notes/C4.mp3"></audio>
    <audio id="Db5" src="../notes/Db4.mp3"></audio>
    <audio id="D5" src="../notes/D4.mp3"></audio>
    <audio id="Eb5" src="../notes/Eb4.mp3"></audio>
    <audio id="E5" src="../notes/E4.mp3"></audio>
    <audio id="F5" src="../notes/F4.mp3"></audio>
    <audio id="Gb5" src="../notes/Gb4.mp3"></audio>
    <audio id="G5" src="../notes/G4.mp3"></audio>
    <audio id="Ab5" src="../notes/Ab4.mp3"></audio>
    <audio id="A5" src="../notes/A4.mp3"></audio>
    <audio id="Bb5" src="../notes/Bb4.mp3"></audio>
    <audio id="B5" src="../notes/B4.mp3"></audio>
    <audio id="C6" src="../notes/C5.mp3"></audio>
    <audio id="Db6" src="../notes/Db5.mp3"></audio>
    <audio id="D6" src="../notes/D5.mp3"></audio>
    <audio id="Eb6" src="../notes/Eb5.mp3"></audio>
    <audio id="E6" src="../notes/E5.mp3"></audio>
    <audio id="F6" src="../notes/F5.mp3"></audio>
    <audio id="Gb6" src="../notes/Gb5.mp3"></audio>
    <audio id="G6" src="../notes/G5.mp3"></audio>
    <audio id="Ab6" src="../notes/Ab5.mp3"></audio>
    <audio id="A6" src="../notes/A5.mp3"></audio>
    <audio id="Bb6" src="../notes/Bb5.mp3"></audio>
    <audio id="B6" src="../notes/B5.mp3"></audio>
    <audio id="C7" src="../notes/C6.mp3"></audio>';
  }
  else if ($_GET['octave']==1) {
    echo '<audio id="C5" src="../notes/C6.mp3"></audio>
    <audio id="Db5" src="../notes/Db6.mp3"></audio>
    <audio id="D5" src="../notes/D6.mp3"></audio>
    <audio id="Eb5" src="../notes/Eb6.mp3"></audio>
    <audio id="E5" src="../notes/E6.mp3"></audio>
    <audio id="F5" src="../notes/F6.mp3"></audio>
    <audio id="Gb5" src="../notes/Gb6.mp3"></audio>
    <audio id="G5" src="../notes/G6.mp3"></audio>
    <audio id="Ab5" src="../notes/Ab6.mp3"></audio>
    <audio id="A5" src="../notes/A6.mp3"></audio>
    <audio id="Bb5" src="../notes/Bb6.mp3"></audio>
    <audio id="B5" src="../notes/B6.mp3"></audio>
    <audio id="C6" src="../notes/C7.mp3"></audio>
    <audio id="Db6" src="../notes/Db7.mp3"></audio>
    <audio id="D6" src="../notes/D7.mp3"></audio>
    <audio id="Eb6" src="../notes/Eb7.mp3"></audio>
    <audio id="E6" src="../notes/E7.mp3"></audio>
    <audio id="F6" src="../notes/F7.mp3"></audio>
    <audio id="Gb6" src="../notes/Gb7.mp3"></audio>
    <audio id="G6" src="../notes/G7.mp3"></audio>
    <audio id="Ab6" src="../notes/Ab7.mp3"></audio>
    <audio id="A6" src="../notes/A7.mp3"></audio>
    <audio id="Bb6" src="../notes/Bb7.mp3"></audio>
    <audio id="B6" src="../notes/B7.mp3"></audio>
    <audio id="C7" src="../notes/C8.mp3"></audio>';
  }
  else{
    echo '<audio id="C5" src="../notes/C5.mp3"></audio>
