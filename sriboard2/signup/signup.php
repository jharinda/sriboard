  ...
  <body>
    <div class="Signupform">
      ...
      if (isset($_GET['error'])) {
          ...
          {
              echo '<p class="error">Enter a Valied Email</p>';
          }
          ...
          {
              echo '<p class="error">Invalied first Name</p>';
          }
            elseif ($_GET['error']=="invalidelastname")
          {
              echo '<p class="error">Invalied Last Name</p>';
          }
        ...
        {
            echo '<p class="error">You must Agree to our trems and conditions</p>';
        }
      }
