  ...
  <tr>
    ...
    <div class="abcd">
      <div class="img1">
        <?php
            if (isset($_SESSION['email'])) {
              echo '<a href="../sriboard/piano.php"><img class="first" id="forhover" src="piano.jpg"  ></a>';
            }else {
      ...
      <div class="img2">
        <?php
            if (isset($_SESSION['email'])) {
              echo '<a href="../sriboard/pizzicato.php"><img class="second" id="forhover"src="pizz.jpg" ></a></a>';
            }else {
      ...
      <div class="img3">
        <?php
            if (isset($_SESSION['email'])) {
              echo '<a href="../sriboard/epiano.php"><img class="third" id="forhover" src="epiano.jpg" ></a>';
            }else {
